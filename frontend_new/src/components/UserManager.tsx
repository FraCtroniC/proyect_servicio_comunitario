...
export default function UserManager({ users, currentUserRole, onSetUserRole, onAddUser, onToggleUserActive }: UserManagerProps) {
  ...
  return (
    <div id="user-manager-container" className="space-y-8 max-w-6xl mx-auto p-2 md:p-4 selection:bg-indigo-100 selection:text-indigo-900">
      ...
      {/* Main Grid: Left is users list, Right is registration form */}
      <div id="users-grid" className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        
        {/* Users List (Col span 2) */}
        <div id="users-list-panel" className="bg-white rounded-xl border border-slate-200/80 p-5 lg:col-span-2 space-y-4">
        ...
        {/* Right Panel: Add new User form (only interactive for super admin & control estudios) */}
        <div id="add-user-panel" className="bg-white rounded-xl border border-slate-200/80 p-5">
          <div id="add-user-header" className="border-b border-slate-100 pb-3 mb-4">
