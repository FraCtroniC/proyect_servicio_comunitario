...
calificacionRoutes.post('/bulk', authorize('Administrador', 'Control de Estudios', 'Docente'), CalificacionController.bulkUpsert);
calificacionRoutes.post('/', authorize('Administrador', 'Control de Estudios', 'Docente'), validateCrearCalificacion, CalificacionController.crear);
calificacionRoutes.patch('/:id', authorize('Administrador', 'Control de Estudios', 'Docente'), CalificacionController.actualizar);
